...
(asdf:defsystem trial
  ...
  :components ((:file "package")
               ...
               (:file "controller" :depends-on ("package" "mapping" "input" "container" "asset" ("assets" "font")))
               ...
               (:file "event-loop" :depends-on ("package" "container"))
               ...
               (:file "scene" :depends-on ("package" "event-loop" "container"))
